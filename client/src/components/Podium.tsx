        ...
        <section className="final-podium">
            <div className="podium-heading">
                <span className="podium-kicker">
                    <Sparkles size={15} /> FINAL RESULTS
                </span>

                <h2>And the room's top three are...</h2>

                <p>Every answer counted. Every point was earned.</p>
            </div>

            <div className="podium-stage">
                <div className="podium-sheen" />

                {places.map((leader, index) =>
                    leader ? (
                        <div
                            className={`podium-card place-${leader.rank}`}
                            key={leader.id}
                        >
